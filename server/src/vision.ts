...
const VISION_PROMPT = `You are a senior brand designer's eyes. The user has shared an image as visual reference for a website they're building. Describe it as design context:
        ...
        messages: [
          {
            ...
            content: [
              ...
              { type: "text", text: body.prompt ?? VISION_PROMPT },
            ],
          },
        ],
      });
